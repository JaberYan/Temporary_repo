...
class LikeDislikeModel(models.Model):
    ...
    post = models.OneToOneField(PostModel,on_delete=models.CASCADE,null=True,blank=True)
    like = models.IntegerField(default=0,null=True,blank=True)
    dislike = models.IntegerField(default=0,null=True,blank=True)
    limit_decrease = models.BooleanField(default=False,null=True,blank=True)
